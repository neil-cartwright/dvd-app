...
<div class="index">
  <h5 class="title">@if(isset($genre))<span class="text-blue">{{ $genre }}</span> <span
      class="badge">{{ $count }}</span> @else All <span class="badge">{{ $count }}</span>@endif</h5>
</div>
  ...
  <table class="u-full-width">
    ...
    <tbody>
      ...
      <tr>
        ...
        @auth
        <td class="hidden-mobile"><a href="/films/show/{{ $film->id }}"><span><i class="far fa-edit"></i></span></a>
        </td>
        @endauth
      </tr>
      @endforeach
