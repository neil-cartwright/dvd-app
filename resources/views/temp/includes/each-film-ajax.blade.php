  <div class="w-full p-6 border-b border-1 border-solid border-gray-400 flex flex-col items-around">
         ...
         mt-2">
                  ...
                  <span class="text-sm italic mr-2"><a class="hover:underline"
                                  href="/films/search/leading_actor/${$film.leading_actor}">${ $film.leading_actor ?
                                  $film.leading_actor
                                  : 'Unknown' }</a></span>
                  <span class="text-sm italic mr-2"><a class="hover:underline"
          ...
          <div class="flex items-center border-t border-dashed border-gray-400">
                  ...
                  <div class="mt-2 ml-6">
                          <a target="_blank" href="https://rottentomatoes.com/search?search=${$film.title}"><img
                                          class="h-8" src="{{ asset('/img/rotten.svg')}}" alt="rotten tomato"></a>
                  </div>
